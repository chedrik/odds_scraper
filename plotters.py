...
def convert_odds_to_list(game, item):  # TODO: better name for this
    ...
    for day,idx in enumerate(days):
        hours = game[item][day].keys()
        hours.sort()
        for hour in hours:
            minutes = game[item][day][hour]
            for minute_data in minutes:
                ...
                time = datetime(game['update_time'].year, month, int(day), int(hour), int(minute_data[0]))
                item_times_list.append(time)
                # TODO: maybe have to set as np.array for the item_list

    return item_times_list, item_list
...
def make_plot():
    ...
    plots = (p1, p2, p3,p1, p2, p3,p1, p2, p3,p1, p2, p3,p1, p2, p3,p1, p2, p3,p1, p2, p3,p1, p2, p3,p1, p2, p3,p1, p2, p3,p1, p2, p3)
    return plots
